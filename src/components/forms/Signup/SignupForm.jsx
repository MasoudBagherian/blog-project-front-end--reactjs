...
const SignupForm = () => {
  ...
  const [form, setForm] = useState({
    firstname: {
      ...
      mainErrMsg: "First name should have at least 2 characters and contains only space and alphabet characters",
      },
    ...
    lastname: {
      ...
      validation: {
        isRequired :true,
          ...
          mainErrMsg: "Last name should have at least 2 characters and contains only space and alphabet characters",
      },
    ...
    password: {
      ...
      validation: {
        isRequired :true,
          ...
          mainErrMsg: "Password should have between 8 and 20 characters and only alphabet and numeric characters and contain at least one capital letter and at least one small letter and at least one numeric character",
      },
  ...
  const inputChangeHandler = (e) => {
    ...
    const {isValid: validStatus, errMsg: message} = checkValidity(value, formInfo[key].validation)
  ...
  return (
    <Fragment>
      ...
      backdropClickHandler={hideModal}>
    ...
    onSubmit={submitHandler}>
      <div className="form__body">
        ...
        <FormImage clickIconHandler={clickIconHandler}
        changeImageHandler={changeImageHandler}
        inputRef={inputFileRef}
        imgRef={imgRef}/>
        <FormGroup label="first name" formField={form.firstname}
        name="firstname"
        inputChangeHandler={inputChangeHandler}
        inputFocusHandler={inputFocusHandler}
        inputBlurHandler={inputBlurHandler}/>
        <FormGroup label="last name" formField={form.lastname}
        name="lastname"
        inputChangeHandler={inputChangeHandler}
        inputFocusHandler={inputFocusHandler}
        inputBlurHandler={inputBlurHandler}/>
        <FormGroup label="email" formField={form.email}
        name="email"
        inputChangeHandler={inputChangeHandler}
        inputFocusHandler={inputFocusHandler}
        inputBlurHandler={inputBlurHandler}/>
        <FormGroup label="username" formField={form.username}
        name="username"
        inputChangeHandler={inputChangeHandler}
        inputFocusHandler={inputFocusHandler}
        inputBlurHandler={inputBlurHandler}/>
        <FormGroup label="password" formField={form.password}
        name="password"
        inputChangeHandler={inputChangeHandler}
        inputFocusHandler={inputFocusHandler}
        inputBlurHandler={inputBlurHandler}/>
        <FormGroup label="confirm password" formField={form.passwordConfirm}
        ...
        className="btn-primary form__btn" type="submit">sign up</button>
      </div>
      <div className="form__footer">
        <p className="form__message">If you have an account, You can log in</p>
        <Link to="/auth/login" className="form__btn btn-secondary">log in</Link>
      </div>
